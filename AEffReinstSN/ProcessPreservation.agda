...
module AEffReinstSN.ProcessPreservation where
...
⇝-↓ₚ-cong id =
  id
⇝-↓ₚ-cong {_} {_} {_} {_} {op} (act {_} {o} {o'} {o''} {i} {i'} {i''} ops op' refl refl) =
  act {o = o} {i = i} (op ∷ₗ ops) op' refl refl
⇝-↓ₚ-cong (par p q) =
...
⇝-⊑ₒ id =
  ⊑ₒ-refl
⇝-⊑ₒ (act {o = o} {i = i} ops op refl refl)
  rewrite ↓↓ₑ-act {o = o} {i = i} ops [ op ]ₗ =
    ↓↓ₑ-⊑ₒ-act ops op
⇝-⊑ₒ (par p q) =
  ∪ₒ-fun (⇝-⊑ₒ p) (⇝-⊑ₒ q)
